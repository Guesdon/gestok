<?php
    ...
    // LOCAL CONFIGURATION #########################################################
    // #############################################################################
    if ($_SERVER['SERVER_NAME']=="gestok" or $_SERVER['REMOTE_ADDR']=="::1") {
    // Conf email support technique
        define('EMAIL_SUPPORT_TECH', 'julien.gues@gmail.com');
    // Conf nom de domaine - Sert pour les communications
        define('WWW_NDD_GENERAL', 'gestok');
    // Conf Database
    ...
    // Definition du path en local de la racine du projet
        define('PATH_MACHINE', 'C:/Users/Julien/OneDrive/Documents/Programme/ORT/Formation_Dev_app/ProjetORT/gestok/');
    // Definition du path du host principal
        define('HTTP_PATH_HOST_PRINCIPAL', 'http://gestok/');
    ...
    // Var de sécurité pour l'authentification
        define('VAR_SECURE_AUTH', '1naho0q');
    // Langue par defaut
